...
`Pull requests <https://github.com/djt5019/github_changelog/pulls>`_ or `Github issues <https://github.com/djt5019/github_changelog/issues>`_ are always welcome.  If you want to contribute a patch please do the following.
